...
const kHomeScreenButtonFirstText = "All";
const kHomeScreenButtonSecondText = "Action";
const kHomeScreenButtonThirdText = "Adventure";
const kHomeScreenButtonFourthText = "Drama";
const kHomeScreenButtonFifthText = "ScienceFiction";

const kHomeScreenTitleText = "Every Matrix";
...
const kDrawerAboutDescText =
    "Hi, My name is Phongharit Pichaiwong and I am a senior mobile developer. This application is created to experiment with connecting a Node.js backend to a MongoDB REST API and integrating it with a Flutter frontend application.";
